...
# Check for a win given the last move (horizontal, vertical, or diagonal)
...
# AI function that computes the best move using minimax
def ai_move(board):
    ...
    def is_valid_location(b, col):
        return b[0][col] == EMPTY  # Check top row
    ...
    # Board-wide win check using the global check_win() function
